...
-- Put Trainer ID in login
UPDATE LOGIN SET TRAINER_ID = 1 WHERE ID = 1;
UPDATE LOGIN SET TRAINER_ID = 2 WHERE ID = 2;
UPDATE LOGIN SET TRAINER_ID = 3 WHERE ID = 3;
UPDATE LOGIN SET TRAINER_ID = 4 WHERE ID = 4;
UPDATE LOGIN SET TRAINER_ID = 5 WHERE ID = 5;
UPDATE LOGIN SET TRAINER_ID = 6 WHERE ID = 6;
UPDATE LOGIN SET TRAINER_ID = 7 WHERE ID = 7;
UPDATE LOGIN SET TRAINER_ID = 8 WHERE ID = 8;
UPDATE LOGIN SET TRAINER_ID = 9 WHERE ID = 9;
UPDATE LOGIN SET TRAINER_ID = 10 WHERE ID = 10;
UPDATE LOGIN SET TRAINER_ID = 11 WHERE ID = 11;
UPDATE LOGIN SET TRAINER_ID = 12 WHERE ID = 12;
